...
module.exports = {
    ...
    async beforeUpdate(event) {
        ...
        const data = await strapi.entityService.findOne("api::educational-program.educational-program", id)
  ...
  const getLocale = async (id) => {
    const res = await strapi.service("api::educational-program.educational-program").findOne(id);
